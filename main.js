...
classification = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/wGYV1-QrB/model.json',modelLoaded);
...
function checkimg(){
    ...
    classification.classify(storedimg, gotResult);
}
